...
namespace EmployeesRecordSystem.Includes
{
    class SQLConfig
    {

        private MySqlConnection con = new MySqlConnection("server=localhost;user id=root;database=dbempinformation;sslMode=none");
